 ...
 */
@RestController
@RequestMapping("/zhuanfangdengji")
public class ZhuanfangdengjiController {
    @Autowired
    private ZhuanfangdengjiService zhuanfangdengjiService;
    ...
    public R update(@RequestBody ZhuanfangdengjiEntity zhuanfangdengji, HttpServletRequest request){
        //ValidatorUtils.validateEntity(zhuanfangdengji);
        zhuanfangdengjiService.updateById(zhuanfangdengji);//全部更新
        return R.ok();
    }
    ...
    public R delete(@RequestBody Long[] ids){
        zhuanfangdengjiService.deleteBatchIds(Arrays.asList(ids));
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<ZhuanfangdengjiEntity> wrapper = new EntityWrapper<ZhuanfangdengjiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = zhuanfangdengjiService.selectCount(wrapper);
