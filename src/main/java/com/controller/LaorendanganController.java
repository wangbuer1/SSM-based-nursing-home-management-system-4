...
public class LaorendanganController {
    ...
    public R page(@RequestParam Map<String, Object> params,LaorendanganEntity laorendangan, 
		...
		if(tableName.equals("jiashu")) {
			laorendangan.setJiashuzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("hugong")) {
			laorendangan.setHugonggonghao((String)request.getSession().getAttribute("username"));
		}
